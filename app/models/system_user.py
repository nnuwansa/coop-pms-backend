...
#     allowed_department_ids: list[int] = []  # NEW
...
#     department_unit: Optional[str] = None  # NEW
#
#
...
class SystemUserModelNamesOut(BaseModel):
    id: int
    name: str
    department_id: Optional[int] = None          # NEW — lets the UI filter assignees by department
    department_unit_id: Optional[int] = None     # NEW — lets the UI filter assignees by sub-unit
